...
-- Stop when one fails and tell me which step number errored.
-- ============================================================
...
-- ── STEP 4: RLS + policies on partners ───────────────────────────────────────
...
-- ── STEP 6: RLS + policies on pricing_config ─────────────────────────────────
...
-- ── STEP 7: seed default pricing row ─────────────────────────────────────────
